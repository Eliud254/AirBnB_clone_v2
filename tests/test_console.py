#!/usr/bin/python3
"""
Tests of the class HBNBCommand
"""
...
class TestConsoleDocs(unittest.TestCase):
    """ Test for documentation of the console"""

    def setUp(self) -> None:
        """Console tests set up"""
...
class TestConsoleCommands(unittest.TestCase):
    """Class to test  documentation of the console help command"""
...
class TestConsoleEOFCommand(unittest.TestCase):
    """Class to  test documentation of the console EOF command"""
...
class TestConsoleAllCommand(unittest.TestCase):
    """Class to test documentation of the console all command"""
...
class TestConsoleShowCommand(unittest.TestCase):
    """Class to test documentation of the console show command"""
...
class TestConsoleCreateCommand(unittest.TestCase):
    """Class to test documentation of the console create command"""
...
class TestConsoleUpdateCommand(unittest.TestCase):
    """Class to test documentation of the console update command"""
...
class TestConsoleDeleteCommand(unittest.TestCase):
    """Class to test documentation of the console delete command"""
